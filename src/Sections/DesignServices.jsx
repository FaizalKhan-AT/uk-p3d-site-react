...
function DesignServices() {
  return (
    <>
      <h2 id="designService" className="mx-5 gotham text-decoration-underline">
        Design services - UAE
      </h2>
      <div className="position-relative ">
        ...
        <h3
          style={{ top: "35%" }}
          className="gotham position-absolute translate-middle start-50 d-flex align-items-center text-center"
        >
